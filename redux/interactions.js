...
const crowdFundingContractAddress =
  '0x79ae3bbe30b86d22d759ead52e94dfa935583236';


// USING ANKR RPC
const anrpc = "https://rpc.ankr.com/xdc_testnet";
const baserpc = "https://rpc.ankr.com/base_sepolia";

//Load web3
export const loadWeb3 = async (dispatch) => {
  const web3 = new Web3(Web3.givenProvider || anrpc);
